...
const laneA = () => runs.run('r6-lane-a', {
  ...
  task: lanePrompt(
    ...
    '/tmp/uiux-r6-lane-a.md'
  ),
  output: '/tmp/uiux-r6-lane-a.md'
});
const laneB = () => runs.run('r6-lane-b', {
  ...
  task: lanePrompt(
    ...
    '/tmp/uiux-r6-lane-b.md'
  ),
  output: '/tmp/uiux-r6-lane-b.md'
});
const laneC = () => runs.run('r6-lane-c', {
...
return { lanes: results.map((r, i) => ({ lane: i + 1, ok: !(r && r.error), error: r && r.error ? r.error : undefined })), files: ['/tmp/uiux-r6-lane-a.md', '/tmp/uiux-r6-lane-b.md', '/tmp/uiux-r6-lane-c.md'] };
