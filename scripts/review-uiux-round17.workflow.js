...
var CONTEXT = [
  'PI WEB repo: /Users/hanxiao.du/Desktop/vincent/projects/pi-web, branch refactor/plugin-architecture, HEAD 0e40b77c.',
  'Convergence round 17 - the verdict round. Round 15 found nine defects in the architecture wave; all were fixed in 5b63f491 and 0e40b77c, with the round-15 triage at docs/design/review-triage-uiux-round16.md.',
  ...
  '- Docs: phone-quality.md, operation-model.md, surfaces-as-plugins.md, review-triage-uiux-round16.md.',
  '',
...
var laneA = runs.run('lane-a', {
  agent: 'design-reviewer-d', timeoutMs: 5400000, label: 'round16 glm A', output: '/tmp/r17-lane-a.md',
...
var laneB = runs.run('lane-b', {
  agent: 'design-reviewer-e', timeoutMs: 5400000, label: 'round16 glm B', output: '/tmp/r17-lane-b.md',
...
var laneC = runs.run('lane-c', {
  agent: 'qwen-parity-reviewer', timeoutMs: 5400000, label: 'round16 qwen full', output: '/tmp/r17-lane-c.md',
