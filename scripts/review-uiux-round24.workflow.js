var meta = { name: 'uiux_convergence_round24', description: 'Convergence verdict round 24: three bllm lanes against the banner-model HEAD; zero findings on all three is the goal' };
var CONTEXT = [
  'PI WEB repo: /Users/hanxiao.du/Desktop/vincent/projects/pi-web, branch refactor/plugin-architecture, HEAD a35c5b7b.',
  'Convergence round 24. Round 17 (docs/design/review-triage-uiux-round17.md) found ~23 defects across three lanes; the mechanical ones were fixed in 646a0d5a and the owner then decided five product questions, all implemented in b0bce2a0, and the round-18 lanes\' 15 further findings fixed in ed0cd40f and the round-19 lanes\' seam findings fixed in 1c2013f7 (see docs/design/review-triage-uiux-round19.md):',
...
var laneA = runs.run('lane-a', {
  agent: 'design-reviewer-d', timeoutMs: 5400000, label: 'round24 glm A', output: '/tmp/r24-lane-a.md',
...
var laneB = runs.run('lane-b', {
  agent: 'design-reviewer-e', timeoutMs: 5400000, label: 'round24 glm B', output: '/tmp/r24-lane-b.md',
...
var laneC = runs.run('lane-c', {
  agent: 'qwen-parity-reviewer', timeoutMs: 5400000, label: 'round24 qwen full', output: '/tmp/r24-lane-c.md',
