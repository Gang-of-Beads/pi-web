...
const laneA = () => runs.run('r14-lane-a', {
  ...
  task: lanePrompt(
    ...
    '/tmp/uiux-r14-lane-a.md'
  ),
  output: '/tmp/uiux-r14-lane-a.md'
});
const laneB = () => runs.run('r14-lane-b', {
  ...
  task: lanePrompt(
    ...
    '/tmp/uiux-r14-lane-b.md'
  ),
  output: '/tmp/uiux-r14-lane-b.md'
});
...
return { lanes: results.map((r, i) => ({ lane: i + 1, ok: !(r && r.error), error: r && r.error ? r.error : undefined })), files: ['/tmp/uiux-r14-lane-a.md', '/tmp/uiux-r14-lane-b.md', '/tmp/uiux-r14-lane-c.md'] };
