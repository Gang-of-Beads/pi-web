...
export class TerminalPanel extends LitElement {
  ...
  static override styles = [xtermStyles, css`
    ...
    .terminal-copy-toolbar button { box-sizing: border-box; flex: 0 0 auto; width: auto; min-height: var(--pi-control-height-comfort); padding: var(--pi-space-3) var(--pi-space-5); font: var(--pi-text-xs) var(--pi-font-mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace); }
