...
function relaysStyles(): string {
  return `
    <style>
      ...
      .viewer { flex: 1 1 auto; box-sizing: border-box; display: grid; align-content: stretch; gap: var(--pi-space-6); min-height: 0; overflow: auto; padding: var(--pi-space-5) var(--pi-reading-edge); }
