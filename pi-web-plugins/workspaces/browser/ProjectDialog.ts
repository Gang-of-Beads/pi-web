...
export class ProjectDialog extends LitElement {
  ...
  static override styles = [css`
    ...
    input[type="text"], input:not([type]) { box-sizing: border-box; min-height: var(--pi-control-height); width: 100%; border: 1px solid var(--pi-border); border-radius: var(--pi-radius-md); background: var(--pi-bg); color: var(--pi-text); padding: var(--pi-space-5); font: var(--pi-control-font-size, 16px) var(--pi-control-monospace-font-family, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace); }
