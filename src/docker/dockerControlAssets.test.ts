...
import { sanitizedGitEnv } from "../server/web/git/gitEnv.js";
...
describe("Docker command assets", () => {
  ...
  it("packages the canonical Docker command and internal support assets", async () => {
    ...
    expect(dockerfile).toContain('"@vincenthanxiaodu/pi-web@${PI_WEB_VERSION}" --allow-scripts=node-pty');
    expect(dockerfile).toContain('peer_pi_bin="${global_root}/@vincenthanxiaodu/pi-web/node_modules/.bin/pi"');
