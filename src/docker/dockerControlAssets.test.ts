...
describe("Docker command assets", () => {
  ...
  it("packages the canonical Docker command and internal support assets", async () => {
    ...
    expect(dockerfile).toContain('"@gang-of-beads/pi-web@${PI_WEB_VERSION}" --allow-scripts=node-pty');
    expect(dockerfile).toContain('peer_pi_bin="${global_root}/@gang-of-beads/pi-web/node_modules/.bin/pi"');
