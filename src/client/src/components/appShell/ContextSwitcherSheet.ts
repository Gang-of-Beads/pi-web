...
export class ContextSwitcherSheet extends LitElement {
  ...
  static override styles = [interactiveSurfaceStyles, listStyles, css`
    ...
    .sheet-header { position: sticky; top: 0; z-index: 4; background: var(--pi-surface); margin-inline: calc(-1 * var(--pi-space-4)); padding-inline: var(--pi-space-4); display: flex; align-items: center; justify-content: space-between; gap: var(--pi-space-4); }
