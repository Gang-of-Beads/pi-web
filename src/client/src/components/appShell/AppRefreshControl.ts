...
export class AppRefreshControl extends LitElement {
  ...
  static override styles = [interactiveSurfaceStyles, css`
    ...
    .app-refresh-button { box-sizing: border-box; width: var(--pi-panel-header-control-height, 44px); height: var(--pi-panel-header-control-height, 44px); display: grid; place-items: center; border: 1px solid var(--pi-border); border-radius: var(--pi-radius-pill); background: var(--pi-surface); color: var(--pi-text); padding: 0; line-height: 1; cursor: pointer; touch-action: manipulation; -webkit-touch-callout: none; }
