...
export class AppPanelEdgeControl extends LitElement {
  ...
  static override styles = css`
    ...
    .edge-button { font: var(--pi-text-xs) var(--pi-font-ui); position: relative; z-index: 1; box-sizing: border-box; display: grid; place-items: center; width: 18px; height: 48px; padding: 0; border: 1px solid var(--pi-border-muted); border-radius: 999px; background: var(--pi-bg); color: var(--pi-muted); opacity: .75; cursor: pointer; }
